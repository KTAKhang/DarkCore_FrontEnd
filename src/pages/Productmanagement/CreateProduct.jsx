...
import { PlusOutlined, CameraOutlined, AppstoreOutlined, ShoppingOutlined, DollarOutlined, ShopOutlined, UserOutlined, InfoCircleOutlined } from "@ant-design/icons";
        ...
        <Card style={customStyles.card}>
          <div style={{ padding: "8px 0" }}>
            <Space direction="vertical" size="large" style={{ width: "100%" }}>
              ...
              <Form form={form} layout="vertical" onFinish={handleFinish} initialValues={{ quantity: 1, price: 1000 }} size="large">
                ...
                <Form.Item label={<Space><InfoCircleOutlined style={{ color: "#13C2C2" }} /><span style={customStyles.label}>Mô tả ngắn</span></Space>} name="short_desc" rules={[{ required: true }]}> <Input.TextArea rows={2} placeholder="Nhập mô tả ngắn" style={{ borderRadius: 8 }} showCount maxLength={200} /> </Form.Item>
                <Form.Item label={<Space><InfoCircleOutlined style={{ color: "#13C2C2" }} /><span style={customStyles.label}>Mô tả chi tiết</span></Space>} name="detail_desc" rules={[{ required: true }]}> <Input.TextArea rows={4} placeholder="Nhập mô tả chi tiết" style={{ borderRadius: 8 }} showCount maxLength={1000} /> </Form.Item>
